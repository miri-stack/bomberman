...
def rotate_map(game_state_val, position):
    ...
    # Replace -1 with wall and 1 with crate.
    game_state['field'][game_state['field'] == 1] = hp.CRATE
    game_state['field'][game_state['field'] == -1] = hp.WALL
...
def rotate_other_values(game_state_val, position):
    game_state = copy.deepcopy(game_state_val)
    field_size = len(game_state['field'])-1 # Assume the map is quadratic
