...
# python main.py play --no-gui --agents all_at_once_agent --train 1 --scenario empty --n-rounds 1000000
# State 2
# python main.py play --no-gui --agents all_at_once_agent --train 1 --scenario coin-heaven
# State 3
# python main.py play --no-gui --agents all_at_once_agent --train 1 --scenario below_classic
# State 3
# python main.py play --no-gui --agents all_at_once_agent --train 1 --scenario classic
...
def reward_from_events(self, events: List[str]) -> int:
    ...
    *This is not a required function, but an idea to structure your code.*
    ...
    game_rewards = {
        ...
        e.SURVIVED_ROUND:20,
        CHANGED_BOMB_DISTANCE: self.bomb_dist_change,
