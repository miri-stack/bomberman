...
# python main.py play --no-gui --agents coini peaceful_agent coin_collector_agent --train 1 --scenario coin-heaven --n-rounds 1000000
# State 2
# python main.py play --no-gui --agents coini peaceful_agent coin_collector_agent --train 1 --scenario loot-crate --n-rounds 1000000
# State 3
# python main.py play --no-gui --agents coini peaceful_agent coin_collector_agent rule_based_agent --train 1 --scenario loot-crate --n-rounds 1000000
