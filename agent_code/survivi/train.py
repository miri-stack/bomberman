...
# python main.py play --no-gui --agents survivi --train 1 --scenario empty
# State 2
# python main.py play --no-gui --agents survivi --train 1 --scenario below_classic
# State 3
# python main.py play --no-gui --agents survivi --train 1 --scenario classic
